...
namespace GrandTripAPI.Migrations
{
    ...
    [Migration("20221214101253_new-column")]
            ...
            modelBuilder.Entity("GrandTripAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Password = "eK6nyeTlRBTISJKWEkgCwFYpv307/5jdqo3IbWgjB9s=",
                            Role = "Admin",
                            Salt = new byte[] { 33, 97, 110, 210, 5, 200, 180, 52, 38, 136, 67, 181, 75, 28, 95, 241 },
                            Username = "teletraan"
                        });
                });
